...
//////// employee list for editing hours

function ListForEditHours (){
  ...
  const serchDivStyl ={
    ...
    function handelClick(employeeID) {
      const hoursPageURL = `/TempletEditHours/${employeeID}/${input.selctYear}/${input.selctMonth}`;
...
export default ListForEditHours;